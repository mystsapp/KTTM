...
namespace KTTM.Models_Cashier
{
    public partial class qlcashierContext : DbContext
    {
        ...
        public virtual DbSet<NtbillDel> NtbillDels { get; set; }
        ...
        public virtual DbSet<VBiennhanNoidium> VBiennhanNoidia { get; set; }
        public virtual DbSet<VBiennhanOutbound> VBiennhanOutbounds { get; set; }
        public virtual DbSet<VBiennhanVanchuyen> VBiennhanVanchuyens { get; set; }
        public virtual DbSet<VBiennhanXuatkhau> VBiennhanXuatkhaus { get; set; }
        public virtual DbSet<VChitietBienNhanIb> VChitietBienNhanIbs { get; set; }
        ...
        public virtual DbSet<VLoaiCard> VLoaiCards { get; set; }
        public virtual DbSet<VNoptien> VNoptiens { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<NtbillDel>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("ntbill_del");
                ...
                entity.Property(e => e.Idntbill).HasColumnType("decimal(18, 0)");
            ...
            modelBuilder.Entity<VBiennhanNoidium>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vBiennhanNoidia");
            ...
            modelBuilder.Entity<VBiennhanOutbound>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vBiennhanOutbound");
            ...
            modelBuilder.Entity<VBiennhanXuatkhau>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vBiennhanXuatkhau");
            ...
            modelBuilder.Entity<VChitietBienNhanIb>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vChitietBienNhanIB");
            ...
            modelBuilder.Entity<VLoaiCard>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vLoaiCard");
            ...
            modelBuilder.Entity<VNoptien>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vNoptien");
